/* AI Agents Quiz · i18n
 * 與 ../i18n.js 同邏輯：
 * - localStorage key 'aiagents_lang'（與教學共用，切換能跨頁同步）
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🤖 AI 代理人互動考題", en:"🤖 AI Agents Interactive Quiz" },
    ...
    quizAllChapters: { zh:"AI 代理人互動考題（全部章節）", en:"AI Agents Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"AI 代理人互動考題", en:"AI Agents Interactive Quiz" },
